...
def check_gpio_permissions():
    ...
    print("=== GPIO Permission Check ===")
        ...
        if os.geteuid() == 0:
            ...
            print(f"Running as user: {pwd.getpwuid(os.getuid()).pw_name}")
            ...
            try:
                ...
                print("'gpio' group not found on this system")
    ...
    if gpiomem_path.exists():
        ...
        print(f"/dev/gpiomem permissions: {mode}")
    ...
    try:
        with open('/proc/modules', 'r') as f:
            ...
            if 'gpio' in modules.lower():
                ...
                print("No GPIO kernel modules found")
    except:
